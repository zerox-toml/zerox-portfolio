      ...
      <Typewriter
        onInit={(typewriter) => {
          typewriter
            ...
            .typeString(
              '<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">Passionate Blogger</span>'
            )
            .pauseFor(3500)
            .deleteAll(17)

            .typeString(
              '<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">Mobile Developer</span>'
            )
            .pauseFor(3500)
            .deleteAll(17)

            .typeString(
              '<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">... </span>'
            )
            .pauseFor(3500)
            .deleteAll(17)
            .start()
